    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 p-8">
        ...
        >
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">{t('email_sent')}</h2>
      ...
      >
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-[hsl(213,80%,28%)]">{t('main_title')}</span>
          </Link>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl shadow-gray-200/50 p-8 border border-gray-100">
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-2">{t('forgot_password_title')}</h2>
