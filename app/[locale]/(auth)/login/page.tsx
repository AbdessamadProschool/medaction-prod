        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          >
            ...
            <div className="space-y-4 mt-12">
              {[
                { Icon: ClipboardList, text: t('feature_reclamations') },
                { Icon: Landmark, text: t('feature_etablissements') },
                { Icon: CalendarDays, text: t('feature_evenements') },
              ].map((item, index) => (
                <motion.div
                  key={index}
