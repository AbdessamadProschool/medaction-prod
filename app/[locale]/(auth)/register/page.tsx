...
export default function RegisterPage() {
  ...
  const step1Schema = z.object({
    prenom: z
      ...
      .max(50, tErrors('firstname_max'))
      .regex(/^[a-zA-ZÀ-ÿ\s'-]+$/, tErrors('firstname_invalid')),
    nom: z
      .string()
  ...
  const step3Schema = z.object({
    password: z
      ...
      .regex(/[A-Z]/, tErrors('password_uppercase'))
      .regex(/[a-z]/, tErrors('password_lowercase'))
      .regex(/[0-9]/, tErrors('password_digit'))
      .regex(/[^A-Za-z0-9]/, tErrors('password_special')),
