...
type ProfileInput = z.infer<typeof baseProfileSchema>;
type PasswordInput = z.infer<typeof basePasswordSchema>;
...
export default function ProfilPage() {
  ...
  const profileSchema = useMemo(() => z.object({
    ...
    nom: z.string().min(2, t('errors.min_2')),
    telephone: z
      .string()
      .regex(/^(\+212|0)[5-7]\d{8}$/, t('errors.invalid_format'))
      .or(z.literal(''))
      .optional(),
  }), [t]);
  ...
  const passwordSchema = useMemo(() => z.object({
    ...
    newPassword: z
      .string()
      .min(8, t('errors.min_8'))
      .regex(/[A-Z]/, t('errors.uppercase'))
      .regex(/[a-z]/, t('errors.lowercase'))
      .regex(/[0-9]/, t('errors.number')),
    confirmPassword: z.string(),
