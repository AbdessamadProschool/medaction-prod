...
const CATEGORIES: Record<string, { label: string; icon: React.ElementType }> = {
  ...
  services: { label: 'Services publics', icon: Landmark },
  environnement: { label: 'Environnement', icon: Leaf },
  education: { label: 'Éducation', icon: GraduationCap },
  sante: { label: 'Santé', icon: HeartPulse },
  transport: { label: 'Transport', icon: Bus },
  culture: { label: 'Culture & Loisirs', icon: Palette },
  numerique: { label: 'Numérique', icon: Laptop },
  autre: { label: 'Autre', icon: Lightbulb },
};
