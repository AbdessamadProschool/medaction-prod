      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="mb-10 relative">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-gray-100">
             ...
             <div className="w-16 h-16 bg-gradient-to-br from-orange-500 to-red-500 rounded-2xl flex items-center justify-center shadow-lg shadow-orange-500/30 transform rotate-3">
            ...
            <div className="p-8 space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="relative group">
                    <input
                      ...
                      className="w-full px-6 py-5 pr-16 rounded-2xl border-2 border-gray-100 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition-all text-xl font-bold placeholder:text-gray-300 placeholder:font-normal bg-gray-50/50 focus:bg-white text-right"
                    />
                     <div className="absolute right-6 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-blue-500 transition-colors pointer-events-none">
                        <LayoutTemplate size={26} />
                     </div>
                </div>
                {errors.titre && <p className="text-red-500 text-sm font-bold flex items-center gap-2 bg-red-50 p-2.5 rounded-xl max-w-fit px-4 text-right"><X size={16}/> {errors.titre.message}</p>}
              </div>
              ...
              <div className="space-y-4">
                ...
                <textarea
                  ...
                  className="w-full px-6 py-5 rounded-2xl border-2 border-gray-100 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition-all text-lg font-medium placeholder:text-gray-300 bg-gray-50/50 focus:bg-white text-right resize-none"
                />
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="relative rounded-2xl border-2 border-gray-100 focus-within:border-blue-500 focus-within:ring-4 focus-within:ring-blue-500/10 transition-all bg-gray-50/50 focus-within:bg-white overflow-hidden">
                    ...
                    className="w-full px-8 py-6 outline-none bg-transparent placeholder:text-gray-300 leading-relaxed text-lg font-medium resize-y text-right"
                    />
                </div>
                {errors.contenu && <p className="text-red-500 text-sm font-bold flex items-center gap-2 bg-red-50 p-2.5 rounded-xl max-w-fit px-4 text-right"><X size={16}/> {errors.contenu.message}</p>}
              </div>
            </div>
          </div>
