      ...
      <div className="max-w-4xl mx-auto px-4 py-4">
        ...
        <div className="mb-5 relative">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 pb-3 border-b border-gray-100">
             ...
             <div className="w-10 h-10 bg-gradient-to-br from-gov-red to-gov-red-dark rounded-xl flex items-center justify-center shadow-lg shadow-orange-500/30 transform rotate-3">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 animate-fade-in-up animation-delay-100">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 hover:shadow-md transition-all duration-300 relative overflow-hidden group">
             <div className="absolute top-0 right-0 rtl:right-auto rtl:left-0 w-32 h-32 bg-gov-blue/5 rounded-bl-[4rem] rtl:rounded-bl-none rtl:rounded-br-[4rem] -mr-8 -mt-8 rtl:-mr-0 rtl:-ml-8 opacity-50 pointer-events-none group-hover:scale-110 transition-transform"></div>
              ...
              <div className="relative group">
                 ...
                 <div className="absolute right-6 rtl:right-auto rtl:left-6 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none group-hover:text-gov-blue-dark transition-colors">
