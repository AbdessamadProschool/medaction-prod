    ...
    <div className="space-y-8">
      ...
      <div className="relative overflow-hidden rounded-[2.5rem] bg-white text-gray-900 shadow-sm border border-gray-100 px-6 py-6 md:px-8 md:py-10">
        ...
        <div className="absolute top-0 right-0 p-8 opacity-5 pointer-events-none">
            <BookOpen className="w-48 h-48 transform rotate-12 text-blue-600" />
        </div>

        <div className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="space-y-3">
                <div className="flex items-center gap-2.5 text-blue-600 font-bold bg-blue-50 w-fit px-3 py-1 rounded-xl border border-blue-100 text-xs uppercase tracking-wider">
      ...
      {loading ? (
        ...
        <>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {(Array.isArray(articles) ? articles : []).map((article: any, index: any) => (
              <div
                key={article.id}
