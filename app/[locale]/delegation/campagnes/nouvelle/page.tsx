      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="mb-10 relative">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-gray-100">
             ...
             <div className="w-16 h-16 bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl flex items-center justify-center shadow-lg shadow-green-500/30 transform -rotate-3">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="p-8">
              {previewUrl ? (
                <div className="relative w-full h-72 bg-gray-100 rounded-[1.5rem] overflow-hidden group shadow-inner border border-gray-100">
                  ...
                  <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center backdrop-blur-sm">
                    <button
                      ...
                      className="px-6 py-3 bg-red-500 text-white rounded-xl hover:bg-red-600 transition-colors font-bold shadow-lg flex items-center gap-2"
                    >
                      <X size={20} />
                      حذف
                    </button>
                ...
                <label className="relative flex flex-col items-center justify-center h-72 border-3 border-dashed border-gray-200 rounded-[1.5rem] bg-gray-50/50 hover:bg-green-50/50 hover:border-green-300 transition-all cursor-pointer group overflow-hidden">
                  ...
                  <p className="text-xl font-bold text-gray-700 mb-2 group-hover:text-green-700 transition-colors">{t('sections.cover.click_to_add')}</p>
          ...
          <div className="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300">
            ...
            <div className="p-8 space-y-8">
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  <label className="block text-lg font-bold text-gray-900 text-right" style={{ textAlign: 'right' }}>
                    {t('sections.general.type')} <span className="text-red-500 text-lg">*</span>
                  </label>
                  <select
                    {...register('type')}
              ...
              <div className="space-y-4">
                <label className="block text-lg font-bold text-gray-900 text-right" style={{ textAlign: 'right' }}>
                  {t('sections.general.campaign_title')} <span className="text-red-500 text-lg">*</span>
                </label>
                <div className="relative group">
                  <input
                    {...register('titre')}
              ...
              <div className="space-y-4">
                ...
                />
                {errors.contenu && <p className="text-red-500 text-sm font-medium bg-red-50 p-2 rounded-lg max-w-fit px-4 text-right">⚠️ {errors.contenu.message}</p>}
              </div>
            </div>
          </div>
