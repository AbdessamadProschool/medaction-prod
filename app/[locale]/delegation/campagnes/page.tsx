                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center gap-3 pt-4 border-t border-gray-100">
                      <Link
                        ...
                        target="_blank"
                        className="p-3 text-blue-600 hover:bg-blue-50 hover:scale-110 rounded-xl transition-transform shrink-0"
                        title={t('view') || 'عرض'}
                      >
                        <ExternalLink size={20} />
                      </Link>
                      
                      {campagne.statut !== 'CLOTUREE' && campagne.statut !== 'TERMINEE' && (
                        <>
