      ...
      if (selectedImage) {
        ...
        try {
          ...
          imageUrl = uploadData.url;
           ...
           toast.error(t('validation.error') + " (Image)");
           setLoading(false);
           return; 
        }
      }
            ...
            <div className="p-8 space-y-8">
              ...
              <div className="space-y-3">
                ...
                <input
                  ...
                  className="w-full px-6 py-4 rounded-2xl border-2 border-gray-100 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 outline-none placeholder:text-gray-300 font-medium shadow-sm transition-all"
                />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300">
            ...
            <div className="p-8 space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-3">
                  <label className="block text-base font-bold text-gray-800 text-right" style={{ textAlign: 'right' }}>
                    {t('sections.datetime.end_date')} <span className="text-gray-400 font-normal text-sm">{t('sections.datetime.optional')}</span>
                  </label>
                  <input
                    {...register('dateFin')}
                    type="date"
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  <label className="block text-base font-bold text-gray-800 text-right" style={{ textAlign: 'right' }}>
                    <Clock className="w-4 h-4 inline ml-2 text-gray-400" />
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  <label className="block text-base font-bold text-gray-800 text-right" style={{ textAlign: 'right' }}>
                    <MapPin className="w-4 h-4 inline ml-2 text-gray-400" />
            ...
            <div className="p-8">
              <div className="grid md:grid-cols-2 gap-8 mb-6">
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    className="w-full px-6 py-4 rounded-2xl border-2 border-gray-100 focus:border-green-500 focus:ring-4 focus:ring-green-500/10 outline-none placeholder:text-gray-300 font-medium transition-all"
                  />
                </div>
              ...
              {watchedInscriptions && (
                <div className="animate-in slide-in-from-top-4 fade-in duration-300 space-y-3">
                  <label className="block text-base font-bold text-gray-700 text-right" style={{ textAlign: 'right' }}>
                    <LinkIcon className="w-4 h-4 inline ml-2 text-gray-400" />
                  ...
                  <input
                    ...
                    className="w-full px-6 py-4 rounded-2xl border-2 border-gray-100 focus:border-green-500 focus:ring-4 focus:ring-green-500/10 outline-none placeholder:text-gray-300 font-medium transition-all text-left ltr:text-right"
                  />
                  {errors.lienInscription && <p className="text-red-500 text-sm mt-2 font-medium">⚠️ {errors.lienInscription.message}</p>}
                </div>
              )}
            </div>
          </div>
