...
export default function DelegationLayout({
  ...
  const SECTEUR_CONFIG: Record<string, { label: string; icon: LucideIcon; color: string }> = {
    SANTE: { label: t('sectors.health'), icon: Heart, color: 'hsl(348,83%,47%)' },
    ...
    ADMINISTRATION: { label: t('sectors.administration'), icon: Landmark, color: 'hsl(220,20%,40%)' },
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Sidebar Desktop */}
      <aside className="hidden lg:fixed lg:inset-y-0 lg:start-0 lg:z-50 lg:flex lg:w-72 lg:flex-col"> {/* Width increased to 72 (18rem) for better RTL fitting */}
        <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-gradient-to-b from-[hsl(213,80%,20%)] to-[hsl(213,80%,28%)] px-6">
          ...
          <div className="flex h-20 shrink-0 items-center border-b border-white/10 mt-1">
            <Link href="/delegation" className="flex items-center gap-3">
              <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-lg" style={{ color: secteurConfig.color }}>
                {(() => { const SIcon = secteurConfig.icon; return <SIcon size={24} strokeWidth={2} />; })()}
              </div>
      ...
      {sidebarOpen && (
        <div className="relative z-50 lg:hidden">
          ...
          <div className="fixed inset-0 flex">
            <div className="relative ltr:mr-16 rtl:ml-16 flex w-full max-w-xs flex-1">
              <div className="absolute ltr:left-full rtl:right-full top-0 flex w-16 justify-center pt-5">
                <button
                  type="button"
              ...
              <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-gradient-to-b from-[hsl(213,80%,20%)] to-[hsl(213,80%,28%)] px-6 pb-4">
                <div className="flex h-20 shrink-0 items-center border-b border-white/10">
                  <span className="mr-3 rtl:ml-3 rtl:mr-0" style={{ color: secteurConfig.color }}>
                    {(() => { const SIcon = secteurConfig.icon; return <SIcon size={24} strokeWidth={2} />; })()}
                  </span>
