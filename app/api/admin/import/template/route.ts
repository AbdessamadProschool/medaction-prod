...
const TEMPLATES: Record<string, string> = {
  etablissement: 'code,nom,secteur,commune,annexe,adresse,latitude,longitude,telephone,email,cycle,nb_classes,nb_enseignants,nb_cadres,eleves_prescolaire_filles,filles_derniere_annee',
  commune: 'nom,code,population,superficie,latitude,longitude',
  annexe: 'nom,code,commune,latitude,longitude',
