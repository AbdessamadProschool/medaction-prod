...
const ACCESS_RULES: Record<string, AccessRule> = {
  ...
  'event_bilan':          { public: false, adminRoles: ['ADMIN', 'SUPER_ADMIN', 'GOUVERNEUR', 'DELEGATION', 'COORDINATEUR_ACTIVITES'] }, // Private Event report gallery images
  'campaign_bilan':       { public: false, adminRoles: ['ADMIN', 'SUPER_ADMIN', 'GOUVERNEUR', 'DELEGATION'] }, // Private Campaign report gallery images
  'event_report':         { public: false, adminRoles: ['ADMIN', 'SUPER_ADMIN', 'GOUVERNEUR', 'DELEGATION', 'COORDINATEUR_ACTIVITES'] }, // Private Event PDF/Word reports
  'campaign_report':      { public: false, adminRoles: ['ADMIN', 'SUPER_ADMIN', 'GOUVERNEUR', 'DELEGATION'] }, // Private Campaign PDF/Word reports
  'activity_report':      { public: false, adminRoles: ['ADMIN', 'SUPER_ADMIN', 'GOUVERNEUR', 'DELEGATION', 'COORDINATEUR_ACTIVITES'] }, // Private Activity reports
