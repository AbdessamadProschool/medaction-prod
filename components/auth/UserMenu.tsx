...
export default function UserMenu() {
  ...
  const getRoleLabel = (role: string) => {
    const labels: Record<string, string> = {
      ...
      COORDINATEUR_ACTIVITES: 'Coordinateur',
  ...
  const getMenuItems = () => {
    ...
    const roleItems: Record<string, Array<{ href: string; label: string; icon: React.FC<{ className?: string }> }>> = {
      CITOYEN: [
        ...
        { href: '/mes-evaluations', label: 'Mes évaluations', icon: StarIcon },
      ],
      DELEGATION: [
      ...
      COORDINATEUR_ACTIVITES: [
        { href: '/coordinateur', label: 'Tableau de bord', icon: DashboardIcon },
        { href: '/coordinateur/calendrier', label: 'Calendrier', icon: CalendarIcon },
      ],
      ADMIN: [
