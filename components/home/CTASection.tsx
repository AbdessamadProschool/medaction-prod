    ...
    <section className="py-20 relative overflow-hidden bg-gradient-to-br from-[hsl(213,80%,25%)] via-[hsl(213,80%,28%)] to-[hsl(213,80%,22%)]">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10" dir={isAr ? 'rtl' : 'ltr'}>
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h2 className={`font-semibold text-white mb-6 leading-tight ${isAr ? 'text-3xl md:text-4xl font-cairo' : 'text-3xl md:text-4xl'}`}>
              {t('cta.citizen_space')}
            </h2>
            <p className={`text-white/80 mb-8 leading-relaxed ${isAr ? 'text-lg' : 'text-lg'}`}>
              {t('cta.citizen_desc')}
            </p>
