            ...
            >
              ...
              <motion.p
                ...
                className={`text-gov-gold-light font-medium mb-4 tracking-wide ${
                  isAr ? 'text-lg md:text-xl font-bold leading-relaxed opacity-90' : 'text-lg md:text-xl'
                }`}
              >
              ...
              <motion.h1
                ...
                className={`font-bold text-white mb-6 leading-tight drop-shadow-lg ${
                  isAr 
                    ? 'text-4xl md:text-5xl lg:text-6xl leading-[1.2] font-cairo font-black' 
              ...
              <motion.p
                ...
                className={`text-white/90 mb-10 max-w-2xl drop-shadow-md ${
                  isAr ? 'text-lg md:text-xl leading-relaxed font-medium opacity-90' : 'text-lg md:text-xl leading-relaxed'
                }`}
              >
