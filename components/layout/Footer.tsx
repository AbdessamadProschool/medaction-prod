            ...
            <div className="flex gap-4">
              {socialLinks.map((item) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-10 h-10 bg-white/5 border border-white/10 rounded-xl flex items-center justify-center hover:bg-gov-blue hover:border-gov-blue transition-all duration-300"
                >
          ...
          <div>
            ...
            <ul className="space-y-3">
              {navigation.discover.map((item) => (
                <li key={item.name}>
                  <Link href={item.href} className="text-gray-400 hover:text-gov-gold transition-colors">
                    {item.name}
                  </Link>
                </li>
              ))}
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-gov-gold mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex items-center gap-3">
                <svg className="w-5 h-5 text-gov-gold flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-2 mb-4 md:mb-0">
              {navigation.legal.map((item) => (
                <Link 
                  key={item.name} 
                  href={item.href}
                  className="text-sm text-gray-400 hover:text-gov-gold transition-colors"
                >
                  {item.name}
                </Link>
              ))}
