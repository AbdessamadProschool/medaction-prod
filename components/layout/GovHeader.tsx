      ...
      <div className="bg-slate-900/50 text-slate-300 py-1.5 border-b border-white/5">
        <div className="w-full px-4 sm:px-6 lg:px-8 flex items-center justify-between text-[11px] font-medium tracking-wide">
          <div className="flex items-center gap-6">
            <span className="flex items-center gap-2 hover:text-white transition-colors cursor-pointer" dir="ltr">
              <Phone size={12} /> 05 22 51 00 51
            </span>
            <span className="hidden sm:flex items-center gap-2 hover:text-white transition-colors cursor-pointer" dir="ltr">
              <Mail size={12} /> contact@provincemediouna.ma
            </span>
          </div>
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <span className="hidden md:block text-sm font-medium max-w-[100px] truncate">
                      {session.user?.prenom || t('common.user')}
                    </span>
                    <ChevronDown size={14} />
                  </button>
          ...
          >
            <nav className="px-4 py-4 space-y-1">
              ...
              <div className="pt-2 pb-1">
                 <p className="px-4 text-xs font-bold text-white/40 uppercase tracking-widest mb-2 mt-2">{t('nav.mediatheque')}</p>
                 {kiosqueItems.map((item) => (
                    <Link
                       key={item.href}
                       href={item.href}
              ...
              <div className="pt-1">
                <p className="px-4 text-xs font-bold text-white/40 uppercase tracking-widest mb-2 mt-2">{t('nav.services')}</p>
