          ...
          {categoriesWithIcons.map((cat) => {
            ...
            return (
              <label
                key={cat.id}
                className={`
                  group relative flex flex-col items-center gap-3 p-4 rounded-xl cursor-pointer transition-all duration-200
                  ${isSelected 
                    ? `${cat.activeBg} border border-blue-600 shadow-lg shadow-blue-50` 
                    : `bg-white border ${cat.border} hover:border-gray-300 hover:shadow-md`
                  }
                `}
              >
                <input
      ...
      <div>
        ...
        <div className="relative group">
          ...
          <input
            ...
            maxLength={100}
          />
          <span className={`absolute ltr:right-4 rtl:left-4 top-1/2 -translate-y-1/2 text-xs font-medium px-2 py-1 rounded-lg ${
      ...
      <div>
        ...
        <div className="relative group">
          <textarea
            ...
            maxLength={2000}
          />
          <span className={`absolute ltr:right-4 rtl:left-4 bottom-4 text-xs font-medium px-2 py-1 rounded-lg ${
