...
const nextConfig = {
  ...
  async rewrites() {
    return [
      // ═══════════════════════════════════════════════════════════════
      // SERVE UPLOADED FILES VIA API (Docker volume compatible)
      // Files are stored in STORAGE_PATH (external volume) and served
      // through /api/uploads/[...path] route for security and flexibility.
      // ═══════════════════════════════════════════════════════════════
      {
        source: '/uploads/:path*',
